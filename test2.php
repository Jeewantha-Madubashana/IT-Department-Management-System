...
<?php
	...
	{	
		...
		// checking not exceed max length
		...
		if (empty($errors)) 
		{
			...
			if ($result) {
				...
				header('Location: student-details.php?user_added=true');
			} else {
...
<body>
	...
	<header>
		...
		<main>
		<h1>Add New Users <span> <a href="users.php"> < Back to User list</a> </span></h1>
