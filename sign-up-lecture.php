		...
		if (empty($errors)) {
			...
			if ($result_set) {
				...
				if (mysqli_num_rows($result_set) == 1) {
					...
					$_SESSION['lec_full_name'] = $user['lec_full_name'];
					$_SESSION['lec_reg_no'] = $user['lec_reg_no'];

					// updatinh last login
						
					
					// redirect to users.php
					header('Location: lecture-portal.php');
				} else {
...
<body>
	<div class="wrapper">
		...
		<div class="intro">
			<h3>Sign up - lecture</h3>
			<div class="loginStudent">

			<form action="sign-up-lecture.php" method="post">
